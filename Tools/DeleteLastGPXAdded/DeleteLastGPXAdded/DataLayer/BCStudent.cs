...
namespace Common
{
    ...
    public class BCStudent
    {
        ...
        public int StudentsUpload(Int32 UserRoleId, Int32 UserId,
            int StudentUploadId, int StudentId, int StagePlanId,
            double StagePlanDistance, double DistanceCovered, string FilePath, string FileName,
            DateTime Uploadeddate, double Kilometer, double Time, int ClassId, int IsValid, int trackCount)
        {
            int result = 0;
            try
            {
        ...
        public int StudentsDeleteLastUpload(Int32 UserRoleId, Int32 UserId,
            int StudentUploadId, int StudentId, int StagePlanId,
            double StagePlanDistance, double DistanceCovered, int ClassId, int IsValid)
        {
            int result = 0;
            try
            {
            ...
            new SqlParameter("@result",SqlDbType.VarChar, 200, ParameterDirection.Output, false, 0,0,"",DataRowVersion.Proposed,result)}, "SP_DELETE_LASTGPX", "@result");
            }
            catch (Exception ex)
            {
                Console.WriteLine("Encountered an Exception, following are the details : \n\n" + ex.Message);
            }
            return result;
        }
        ...
        public int StudentsUploadExtraSpeed(Int32 UserRoleId, Int32 UserId,
            int StudentUploadId, int StudentId, int StagePlanId,
            double StagePlanDistance, double DistanceCovered, string FilePath, string FileName,
            DateTime Uploadeddate, double Kilometer, double Time, int ClassId, int IsValid, int trackCount)
        {
