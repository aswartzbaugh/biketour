<%@ page title="Bike Tour - Change Your Password" culture="de-DE" uiculture="de-DE" language="C#" masterpagefile="~/SiteMaster/AdminMaster.master" autoeventwireup="true" inherits="ChangePassword_ChangePassword, App_Web_czoj0jh4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
   <h5>
    <asp:Label ID="lblChangePassword" runat="server" meta:ResourceKey="lblChangePassword"></asp:Label>
    </h5>
            ...
            <table cellspacing="8">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" meta:ResourceKey="RequiredFieldValidator1" runat="server" ControlToValidate="txtCurrentPassword"
                            Display="Dynamic" CssClass="error" ValidationGroup="Save"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td style="width: 175px">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  meta:ResourceKey="RequiredFieldValidator2" ControlToValidate="txtNewPswd"
                            Display="Dynamic" CssClass="error"  ValidationGroup="Save"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3"  meta:ResourceKey="RequiredFieldValidator3"  runat="server" ControlToValidate="txtConfirm"
                            Display="Dynamic" CssClass="error"  ValidationGroup="Save"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator1" meta:ResourceKey="CompareValidator1"  runat="server"
                            ...
                            <asp:CompareValidator ID="CompareValidator2"  meta:ResourceKey="CompareValidator2" runat="server"
