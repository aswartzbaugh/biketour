...
--%>
<%@ control language="C#" autoeventwireup="true" inherits="GoogleMapForASPNet, App_Web_hwiqdigv" %>
...
<script src="http://maps.google.com/maps?file=api&amp;v=<%=GoogleMapObject.APIVersion %>&amp;key=<%=GoogleMapObject.APIKey%>&hl=de"  type="text/javascript"></script>
