<%@ page title="Bike Tour - Change Your Password" culture="de-DE" uiculture="de-DE" language="C#" masterpagefile="~/SiteMaster/AdminMaster.master" autoeventwireup="true" inherits="ChangePassword_ChangePassword, App_Web_qvm2tkwv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
    <h5>
    <asp:Label ID="lblHead" runat="server" meta:RsourceKey="lblHead">
    </asp:Label></h5>
