<%@ page title="Student Details" culture="de-DE" uiculture="de-DE" language="C#" masterpagefile="~/SiteMaster/AdminMaster.master" autoeventwireup="true" inherits="ClassAdmin_StudentDetails, App_Web_tvrek5y1" %>
...
<script type="text/javascript">
    ...
    <div class="container">
        ...
        <div class="GridWrap" >
         ...
         <div>
            <br />
            <h3><asp:Label ID="lblUpdateStud" runat="server" meta:ResourceKey="lblUpdateStud"></asp:Label>
            </h3>
            <asp:Panel ID="pnl_MyProfile" runat="server" >
                <table border="0" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                        <td><asp:Label ID="lblUsername" runat="server" meta:ResourceKey="lblUsername" CssClass="Glblbl"></asp:Label>
                           </td>
                        <td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><asp:Button ID="btn_Save" runat="server" meta:ResourceKey="btn_Save" 
