<%@ page title="Bike Tour - Forum" culture="de-DE" uiculture="de-DE" language="C#" masterpagefile="~/SiteMaster/AdminMaster.master" autoeventwireup="true" inherits="Student_Forum, App_Web_ns4255fk" %>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lbtnUpload" runat="server" meta:ResourceKey="lbtnUpload" CssClass="glbtn"
                                                    PostBackUrl="~/Student/UploadGpx.aspx"></asp:LinkButton>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
