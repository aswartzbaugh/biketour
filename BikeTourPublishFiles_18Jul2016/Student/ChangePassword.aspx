<%@ page title="Bike Tour - Change Your Password" culture="de-DE" uiculture="de-DE" language="C#" masterpagefile="~/SiteMaster/AdminMaster.master" autoeventwireup="true" inherits="ChangePassword_ChangePassword, App_Web_whqge5hn" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:CompareValidator ID="CompareValidator1" runat="server"
                             meta:ResourceKey="CompareValidator1" ControlToCompare="txtNewPswd" ControlToValidate="txtConfirm" CssClass="error"
